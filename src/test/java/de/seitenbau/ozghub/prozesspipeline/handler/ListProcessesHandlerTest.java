...
import de.seitenbau.ozghub.prozesspipeline.model.response.Deployment;
...
public class ListProcessesHandlerTest
{
  ...
  public void listProcesses()
  {
    ...
    DeploymentList deploymentList = prepareDeployment(deploymentDate);
  ...
  private DeploymentList prepareDeployment(Date deploymentDate)
  {
    ...
    Deployment deployment1 = Deployment.builder()
    ...
    return DeploymentList.builder().complete(true).value(List.of(deployment1)).build();
  }
  ...
  private String createExpectedLogMessage(Date deploymentDate, Deployment deployment1)
  {
  ...
  private HttpHandler createAndStartHttpServer(DeploymentList deploymentList)
  {
  ...
  @SneakyThrows
  private HttpHandler createHttpHandler(DeploymentList deploymentList)
  {
